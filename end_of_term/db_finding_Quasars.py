...
--This programme searches through SDSS DR14, a catalogue of confirmed quasars,
...
def makeCSV(filename_input, source_id_input, ra_input, dec_input, mjd_input, w1_input, w1sig_input, w2_input, w2sig_input, w3_input, w3sig_input, w4_input, w4sig_input):
    outfile = open('../csvfiles_Quasars/'+filename_input+'.csv', 'w') #creates/opens the csv file for appending
...
def main(): #raiding the quasar catalogue, acts as the main.
    cat = fits.open("../../Catalogs/DR14Q_v3_1.fits") #Change this line to match your file system.
    ...
    #167260
    try:
        file = open('EntryNumber_QSO.txt', 'r')
        text = file.read()
